								...
								<div class="form-group row m-b-15">
									...
									<div class="col-md-8 col-sm-8">
										<div style="width:100%; border:0px solid #000;padding: 5px;">
											...
											?>
											<div style="float: left;padding:10px;border: 1px solid #ddd;border-radius: 4px; margin-left: 10px; font-weight: bold;"><input type="checkbox" data-proid="<?php echo $v->id; ?>" name="processesid[]" id="processesid[]" class="checkprocsses" value="<?php echo $v->id; ?>"><?php echo $v->processes_name;?></div>
