<?php 
	...
	$orgid = $getalllinemager[0]->organization_id; 
	$conid = $getalllinemager[0]->id;

	$proid = explode(',',$getalllinemager[0]->processes_id);
	$userdata 	= json_decode($this->AdminModel->getuserById($conid)); 

	$getorgbyId 	= $this->AdminModel->getorganizationbyId($orgid); 
	$processesval 	= $this->AdminModel->getSubproByPro($proid);
						...
						<div class="panel-body">
							<div class="details_content">
								...
								<div class="details_right">
									...
									?>
										<a href="<?php echo ADMIN_URL?>setprocesses/<?php echo base64_encode($getalllinemager[0]->id); ?>/<?php echo base64_encode($processdata[0]); ?>"><span class="label label-success m-l-5 t-minus-1"><?php echo $processdata[2]; ?></span></a>
									<?php 
											}
										}
									?>
